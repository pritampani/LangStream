...
load_dotenv(dotenv_path="/Users/pritampani/Downloads/FlaskUI 2/.env")
...
app = Flask(__name__)
CORS(app)
app.config['UPLOAD_FOLDER'] = '/Users/pritampani/Downloads/FlaskUI 2/uploads'
...
def generate_vtt(transcript, total_duration, num_blocks, offset=0.0):
    ...
    for i in range(num_blocks):
        # Adjust the start and end times with the offset
